...
<div
	in:fade={{ delay: 200 }}
	class="animate relative -z-10 flex flex-col items-center justify-center gap-x-2 gap-y-2 p-4 md:flex-row md:justify-around"
>
	<div class="relative -z-10 mt-2 h-full min-h-[7.5rem] w-full">
		<div class="z-20">
